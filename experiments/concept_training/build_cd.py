...
Loads a trained model checkpoint from a run directory produced by ct-train,
...
Usage
-----
    ct-cd --run-dir outputs/VAEE-256x128-20260430_120000
    ct-cd --run-dir outputs/TopK-64-SAE-16384-20260430_120000 --split train
    ct-cd --run-dir outputs/L1-0.001-SAE-256-20260430_120000 --top-k 20
"""
...
from experiments.concept_training.model_adapter import (
    ModelAdapter,
    SparseAEAdapter,
    VAEEAdapter,
...
def main() -> None:  # noqa: PLR0915
    ...
    parser.add_argument(
        ...
        "-r",
        required=True,
        help="Run output directory produced by ct-train.",
    )
    parser.add_argument(
        "--split",
        "-s",
    ...
    parser.add_argument(
        ...
        "-o",
        default=None,
        help="Output HTML path. Defaults to {run_dir}/{ckpt_stem}_{split}_cd.html.",
    )
